...
const contractABI = require("../artifacts/contracts/Sequencestack.sol/Sequencestack.json").abi;

program
    .name("sequencestack-cli")
    .description("CLI tool for Sequencestack smart contract")
    .version("1.0.0");
